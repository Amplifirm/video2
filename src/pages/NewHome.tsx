...
const SplitTextReveal: React.FC<{
  ...
  return (
    ...
    >
      {words.map((word, i) => (
        <motion.span key={i} className="inline-block mr-1.5 last:mr-0" variants={child}>
          {word}
        </motion.span>
      ))}
    </motion.span>
...
// Global styles - can be imported from a separate file
const GlobalStyles = `
  ...
  * {
  ...
  /* Utility classes for backdrop blur */
  .backdrop-blur-sm {
